...
class MerchantBloc extends Cubit<MerchantState> {
  ...
  saveMerchant(
    ...
    try {
      var result = await UserService.createMerchant(data.toJson(), isUpdating);

      if (result.success == true) {
        if (isUpdating) {
          updateGlobalSelectedMerchant(User.fromJson(result.data));
        }
        showWhiteDialog(
          context,
          ResponseDialog(
  ...
  updateGlobalSelectedMerchant(User data) {
