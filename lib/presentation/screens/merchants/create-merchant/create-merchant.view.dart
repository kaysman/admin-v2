...
class _CreateMerchantState extends State<CreateMerchant>
  ...
  void checkIfUserIsUpdating() {
    if (UserService.selectedMerchant.value != null) {
      ...
      _trackingEmailAddressController.text =
          merchant?.merchant?.trackingEmail ?? '';
      _trackingPhoneNumberController.text =
          merchant?.merchant?.trackingPhoneNumber ?? '';
    }
  }
  ...
  submitForm(
    ...
    Address _address = Address(
      ...
      specificTypeOfLocation: SpecificTypeOfLocation.MERCHANT_ANY_LOCATION,
      typeOfContactForAddress: TypeOfContactForAddress.MERCHANT,
    );
    ...
    MerchantDetails _merchantDetails = MerchantDetails(
      ...
      trackingEmail: _trackingEmailAddressController.text,
      trackingPhoneNumber: _trackingPhoneNumberController.text,
    );
    ...
    CreateUserWithinSystem merchantUser = CreateUserWithinSystem(
      ...
      typeOfUserCreated: SpecificTypeOfUser.MERCHANT,
    );

    await merchantBloc.saveMerchant(merchantUser, context, isUpdating);
  }
}
