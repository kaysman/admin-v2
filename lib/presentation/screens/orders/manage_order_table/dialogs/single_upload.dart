...
class _UploadSingleDialogState extends State<UploadSingleDialog> with WidgetsBindingObserver {
  ...
  submitSingleUploadForm(OrderBloc orderBloc, BuildContext context) async {
    ...
    SingleOrderUploadModel _data = SingleOrderUploadModel(
      merchantId: "80870c77-e541-4ad7-a93e-a98935bc91cf",
...
class _PickupDetailsScreen extends StatefulWidget {
  final GlobalKey<FormState>? formKey;
  ...
  @override
  State<_PickupDetailsScreen> createState() => __PickupDetailsScreenState();
}

class __PickupDetailsScreenState extends State<_PickupDetailsScreen> {
  @override
  Widget build(BuildContext context) {
    return Form(
      key: widget.formKey,
      child: Column(
        ...
        children: [
          ...
          LabeledInput(
            label: "Pickup note",
            controller: widget.pickupNoteController!,
          ),
        ],
      ),
    );
