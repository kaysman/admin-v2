...
import '../screens/operational_flow/create_flow.dart';
import '../screens/operational_flow/operational_flow_list.dart';
import '../screens/operational_flow/workflow_detail_page.dart';
    ...
    case EditOrganizationInfo.routeName:
      return MaterialPageRoute(
        ...
        builder: (context) => EditOrganizationInfo(
          userIdentity: settings.arguments as User,
        ),
      );
